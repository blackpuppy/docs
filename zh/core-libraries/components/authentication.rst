...
.. meta::
    :title lang=zh_CN: Authentication
    :keywords lang=zh_CN: authentication handlers,array php,basic authentication,web application,different ways,credentials,exceptions,cakephp,logging
