...
.. meta::
    :title lang=zh_CN: RssHelper
    :description lang=zh_CN: The RSS helper makes generating XML for RSS feeds easy.
    :keywords lang=zh_CN: rss helper,rss feed,isrss,rss item,channel data,document data,parse extensions,request handler
