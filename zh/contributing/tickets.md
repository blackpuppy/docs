...
不要使用问题跟踪系统、邮件列表或IRC。请发送电子邮件至**security [at] cakephp.org**。
发送到这个地址的电子邮件会进入一个CakePHP的核心团队所在的内部邮件列表中。

对于每一份报告，我们首先尝试确认该漏洞。一经确认，CakePHP团队将采取以下措施：

* 向报告者确认我们已经收到了该问题报告，并正着手修复。
  我们请求额报告者保持保密，直到我们对外宣布此问题。
* 准备一个更正/补丁。
* 准备一个帖子描述该漏洞，以及如何利用该漏洞的可能方式。
* 针对所有受影响的版本发布新版本。
* 在版本发布公告中明确地说明该问题。
